...
$eredmeny = getVarosiAutoById($dbc, $varosi_auto_id);
?>
                        ...
                        <div class="sparkline8-list mt-b-30">
                            <div class="sparkline8-hd">
                                <div class="main-sparkline8-hd">
                                    <h1 class="color-white">Városi autó (4,6m) módosítása</h1>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="basic-login-inner">
                                                ...
                                                <form id="varosiAutoEdit" action="varosi-auto-modositas.php?varosi_auto_id=<?php esc($eredmeny['varosi_auto_id']) ?>" method="POST">
                                                    <div class="form-group-inner">
                                                        <label class="form-group-inner__label color-white">Alap</label>
                                                        <input name="varosi_auto_alap" id="varosi_auto_alap" type="text" class="form-control" value="<?php esc($eredmeny['alap'])  ?>" required />
                                                    </div>
                                                    <div class=" form-group-inner">
                                                        <label class="form-group-inner__label color-white">Prémium / Kozmikus</label>
                                                        <input name="varosi_auto_premium_kozmikus" id="varosi_auto_premium_kozmikus" type="text" class="form-control" value="<?php esc($eredmeny['premium_kozmikus'])  ?>" required />
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <label class="form-group-inner__label color-white">Professzionális / Galaktikus</label>
                                                        <input name="varosi_auto_professzionalis_galaktikus" id="varosi_auto_professzionalis_galaktikus" type="text" class="form-control" value="<?php esc($eredmeny['professzionalis_galaktikus'])  ?>" required />
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <label class="form-group-inner__label color-white">Megjegyzés</label>
                                                        <input name="varosi_auto_megjegyzes" id="varosi_auto_megjegyzes" type="text" class="form-control" value="<?php esc($eredmeny['megjegyzes'])  ?>" required />
                                                    </div>
                                                    <div class="login-btn-inner">
                                                        <div class="inline-remember-me">
                                                            <input type="hidden" name="event" id="event" value="varosiAutoEdit">
