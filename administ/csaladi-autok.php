                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline8-list mt-b-30">
                            ...
                            <table class="basic-form-area__table">
                                <thead>
                                    <h3 class="basic-form-area__table__thead__h3 strong-font">Csaladi autó (4,6m)</h3>
                                    <tr>
                                ...
                                <tbody>
                                    <?php foreach ($getCsaladiAuto as $csaladiAuto) : ?>
                                        <tr>
                                            <td data-label="Alap" class="color-white"><?php esc($csaladiAuto["alap"]) ?></td>
                                            <td data-label="Prémium / Kozmikus" class="color-white"><?php esc($csaladiAuto["premium_kozmikus"]) ?></td>
                                            <td data-label="Professzionális / Galaktikus" class="color-white"><?php esc($csaladiAuto["professzionalis_galaktikus"]) ?></td>
                                            <td data-label="-" class="color-white"><?php esc($csaladiAuto["megjegyzes"]) ?></td>
                                            <td>
                                                <a href="csaladi-auto-modositas.php?csaladi_auto_id=<?php esc($csaladiAuto["csaladi_auto_id"]) ?>">Módosítás</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
