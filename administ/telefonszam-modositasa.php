...
$eredmeny = telefonszamById($dbc, $telefonszam_id);
?>
                        ...
                        <div class="sparkline8-list mt-b-30">
                            <div class="sparkline8-hd">
                                <div class="main-sparkline8-hd">
                                    <h1 class="color-white">Telefonszám módosítása</h1>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="basic-login-inner">
                                                ...
                                                <form id="telefonszamEdit" action="telefonszam-modositasa.php?telefonszam_id=<?php esc($eredmeny['telefonszam_id']) ?>" method="POST">
                                                    <div class="form-group-inner">
                                                        <label class="form-group-inner__label color-white">Telefonszám</label>
                                                        <input name="telefonszam" id="telefonszam" type="text" class="form-control" value="<?php esc($eredmeny['telefonszam'])  ?>" required />
                                                    </div>
                                                    <div class="login-btn-inner">
                                                        <div class="inline-remember-me">
                                                            <input type="hidden" name="event" id="event" value="telefonszamEdit">
